...
namespace MonoFlat
{
    ...
    public class MonoFlat_ThemeContainer : ContainerControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.DrawString(Text, new Font("Microsoft Sans Serif", 12, FontStyle.Bold),
                new SolidBrush(Color.FromArgb(255, 254, 255)), new Rectangle(20, 20, Width - 1, Height),
    ...
    internal class MonoFlat_ControlBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_EnableHoverHighlight)
            {
                switch (ButtonHState)
                {
                    ...
                    case ButtonHoverState.Maximize:
                        if (_EnableMaximize)
                        {
                            G.FillRectangle(new SolidBrush(Color.FromArgb(156, 35, 35)),
            ...
            //Close
            G.DrawString("r", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(255, 254, 255)),
                new Point(Width - 16, 8), new StringFormat {Alignment = StringAlignment.Center});
            ...
            switch (Parent.FindForm().WindowState)
            {
                case FormWindowState.Maximized:
                    if (_EnableMaximize)
                    {
                        G.DrawString("2", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(255, 254, 255)),
                            new Point(51, 7), new StringFormat {Alignment = StringAlignment.Center});
                    }
                    else
                    {
                        G.DrawString("2", new Font("Marlett", 12), new SolidBrush(Color.LightGray), new Point(51, 7),
                ...
                case FormWindowState.Normal:
                    if (_EnableMaximize)
                    {
                        G.DrawString("1", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(255, 254, 255)),
                            new Point(51, 7), new StringFormat {Alignment = StringAlignment.Center});
                    }
                    else
                    {
                        G.DrawString("1", new Font("Marlett", 12), new SolidBrush(Color.LightGray), new Point(51, 7),
                            new StringFormat {Alignment = StringAlignment.Center});
                    }
                    break;
            }
            ...
            if (_EnableMinimize)
            {
                G.DrawString("0", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(255, 254, 255)),
                    new Point(20, 7), new StringFormat {Alignment = StringAlignment.Center});
            }
            else
            {
                G.DrawString("0", new Font("Marlett", 12), new SolidBrush(Color.LightGray), new Point(20, 7),
                    new StringFormat {Alignment = StringAlignment.Center});
            }
        }
    ...
    public class MonoFlat_Button : Control
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(181, 41, 42),
                    Color.FromArgb(181, 41, 42), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(165, 37, 37),
                    Color.FromArgb(165, 37, 37), 90.0F);
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (ToggleType)
            {
                case _Type.CheckMark:
                    if (Toggled)
                    {
                        G.DrawString("ü", new Font("Wingdings", 18, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 18,
                            Bar.Y + 19,
                            new StringFormat
                            {
                    ...
                    {
                        G.DrawString("r", new Font("Marlett", 14, FontStyle.Regular), Brushes.DimGray, Bar.X + 59,
                            Bar.Y + 18,
                            new StringFormat
                            {
                                Alignment = StringAlignment.Center,
                ...
                case _Type.OnOff:
                    ...
                    {
                        G.DrawString("OFF", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.DimGray, Bar.X + 57,
                            Bar.Y + 16,
                            new StringFormat
                            {
                                Alignment = StringAlignment.Center,
                ...
                case _Type.YesNo:
                    if (Toggled)
                    {
                        G.DrawString("YES", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 19,
                            Bar.Y + 16,
                            new StringFormat
                            {
                                Alignment = StringAlignment.Center,
                    ...
                    {
                        G.DrawString("NO", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.DimGray, Bar.X + 56,
                            Bar.Y + 16,
                            new StringFormat
                            {
                                Alignment = StringAlignment.Center,
                ...
                case _Type.IO:
                    ...
                    {
                        G.DrawString("O", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.DimGray, Bar.X + 57,
                            Bar.Y + 16,
                            new StringFormat
                            {
                                Alignment = StringAlignment.Center,
    ...
    public class MonoFlat_CheckBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Enabled)
            {
                if (_Checked)
                {
                    G.DrawString("a", new Font("Marlett", 16), new SolidBrush(Color.FromArgb(181, 41, 42)),
                        new Point(-5, -3));
                }
            }
            else
    ...
    public class MonoFlat_RadioButton : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_Checked)
            {
                G.DrawString("a", new Font("Marlett", 15), new SolidBrush(Color.FromArgb(181, 41, 42)),
                    new Point(-3, -2));
            }
    ...
    public class MonoFlat_TrackBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillEllipse(new SolidBrush(Color.FromArgb(181, 41, 42)),
            ...
            G.DrawEllipse(new Pen(Color.FromArgb(181, 41, 42)),
                TrackThumb.X + (int) Math.Round(unchecked(TrackThumb.Width*(Value/(double) Maximum))) -
                (int) Math.Round(ThumbSize.Width/2.0),
                TrackThumb.Y + (int) Math.Round(TrackThumb.Height/2.0) - (int) Math.Round(ThumbSize.Height/2.0),
                ThumbSize.Width, ThumbSize.Height);
    ...
    public class MonoFlat_NotificationBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_ShowCloseButton)
            {
                ...
                GFX.DrawString("r", new Font("Marlett", 7, FontStyle.Regular),
                    new SolidBrush(Color.FromArgb(130, 130, 130)), new Rectangle(Width - 20, 10, Width, Height),
                    new StringFormat {Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near});
            }
