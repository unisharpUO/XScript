...
public abstract class ThemeContainer152 : ContainerControl
{
    ...
    protected override sealed void OnParentChanged(EventArgs e)
    {
        ...
        if (!ControlMode)
        {
            ...
            if ((ParentForm != null) && IsParentForm)
            {
    ...
    protected override void OnMouseDown(MouseEventArgs e)
    {
        ...
        if ((ParentForm != null) &&
            (!(IsParentForm && ParentForm.WindowState == FormWindowState.Maximized || ControlMode)))
        {
    ...
    public Color TransparencyKey
    {
        get
        {
            if ((ParentForm != null) && IsParentForm && !ControlMode)
    ...
    protected bool ControlMode { get; set; }
    ...
    protected void DrawText(Brush b1, string text, HorizontalAlignment a, int x, int y)
    {
        ...
        DrawTextPoint = ControlMode
            ? Center(DrawTextSize)
            : new Point(Width/2 - DrawTextSize.Width/2, MoveHeight/2 - DrawTextSize.Height/2);
    ...
    protected void DrawImage(Image image, HorizontalAlignment a, int x, int y)
    {
        ...
        DrawImagePoint = ControlMode
            ? Center(image.Size)
            : new Point(Width/2 - image.Width/2, MoveHeight/2 - image.Height/2);
    ...
    {
        DrawGradientBrush = new LinearGradientBrush(r, Color.Empty, Color.Empty, angle) {InterpolationColors = blend};
...
public abstract class ThemeControl152 : Control
{
    ...
    private void InvalidateCustimization()
    {
        ...
        {
            M.Write(BitConverter.GetBytes(bloom.Value.ToArgb()), 0, 4);
        }
