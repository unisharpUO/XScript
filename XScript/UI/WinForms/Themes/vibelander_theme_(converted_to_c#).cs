...
public class TxtBox : ThemeControl
{
    ...
    public override void PaintHook()
    {
        ...
        var p = new Pen(Color.FromArgb(204, 204, 204), 1);
        var o = new Pen(Color.FromArgb(249, 249, 249), 8);
        ...
        var drawFont = new Font("Tahoma", 9, FontStyle.Regular);
        {
    ...
    public override void PaintHook()
    {
        ...
        switch (MouseState)
        {
            ...
            case State.MouseDown:
                ...
                var x1 = new LinearGradientBrush(ClientRectangle, Color.FromArgb(37, 124, 196),
